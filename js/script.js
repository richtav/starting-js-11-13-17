...
apollo.speak();
// With functions that use multiple parameter the order matters, supply the parameter in the same order in which the argumens are listed where the function is defined
